      ...
      <section className="bg-primary-800 text-white">
        <div className="container-max py-16 sm:py-24">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-primary-800 shadow-sm hover:bg-primary-50"
            >
              Maak een afspraak
            </Link>
            <a
              href={`tel:${siteConfig.contactPhone.replace(/\s/g, "")}`}
              className="inline-flex items-center justify-center rounded-full border border-primary-400 px-6 py-3 text-sm font-semibold text-white hover:bg-primary-700"
            >
      ...
      <section className="container-max py-14 sm:py-16">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {diensten.map((dienst) => (
            <div
              key={dienst.title}
              className="flex flex-col gap-2 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/60"
            >
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary-50 text-xs font-semibold text-primary-700">
                {dienst.icon}
              </span>
              <h3 className="text-sm font-semibold text-slate-900">
                {dienst.title}
              </h3>
              <p className="text-xs text-slate-600">{dienst.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="container-max py-14 sm:py-16">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/60">
              <p className="font-semibold text-slate-900">50+ jaar ervaring</p>
